...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($run) {
            echo "<script>alert('Category UPDATED');window.location.href='categorylist.php';</script>";
        }
        else{
            echo "<script>alert('Category Addesssd');window.location.href='editcategory.php';</script>";
        }
...
<div class="container">
  ...
  <div class="form-row">
    ...
    <div class="col">
        <small>Foreing Key</small>
      <input type="text" class="form-control" name="frky" value="<?php echo$fk; ?>" placeholder="Foreing Key">
    </div>
    <div class="col">
