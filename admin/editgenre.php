...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($run) {
            echo "<script>alert('GENRE UPDATED');window.location.href='genrelist.php';</script>";
        }
        else{
            echo "<script>alert('GENRE Addesssd');window.location.href='editgenre.php';</script>";
        }
    }
...
<div class="container">
    <div class="head">
        <h1>Edit Genre</h1>
        <div class="jumbotron">
            <h1 class="display-4">Edit a Genre</h1>
            ...
            <form action="#" method="post">
                ...
                <br><br>
                <button class="btn btn-primary btn-lg" name="submit" type="submit" role="button">Edit Genre</button>
            </form>
        </div>
    </div>
</div>