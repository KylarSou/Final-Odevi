...
<div class="container">
  ...
  <div class="form-group">
    ...
    <input type="text" name="mv_m_desc" class="form-control" placeholder="Enter Movie description" >
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="mv_lang" class="form-control" placeholder="Enter Movie Langueage" >
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="cat_id" class="form-control" placeholder="Enter Movie category ID" >
  </div>
  <div class="form-group">
